<x-app-layout>
	...
	<div class="section sec-halfs py-0">
		<div class="container">
			<div class="half-content d-lg-flex align-items-stretch mt-3">
			...
			<div class="half-content d-lg-flex align-items-stretch my-3">
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-7 mb-4 mb-lg-0">
					<img src="{{url('assets/images/img_7_sq.jpg')}}" alt="Image" class="img-fluid rounded
					">
				</div>
				<div class="col-lg-4 ps-lg-2">
					...
					<div class="d-flex mb-3 service-alt">
						<div>
							<span class="bi-wallet-fill me-4 bg-primary"></span>
						</div>
						<div>
							<h3>Building your blog</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
					...
					<div class="d-flex mb-3 service-alt">
						<div>
							<span class="bi-pie-chart-fill me-4 bg-primary"></span>
						</div>
						<div>
							<h3>Resources and insights</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
					...
					<div class="d-flex mb-3 service-alt">
						<div>
							<span class="bi-bag-check-fill me-4 bg-primary"></span>
						</div>
						<div>
							<h3>Blog just for you</h3>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
