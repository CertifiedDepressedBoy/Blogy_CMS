                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" value="{{$post->title ? $post->title : old('title')}}" class="form-control rounded  @error('title') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="" cols="30" rows="10" class="form-control rounded  @error('description') is-invalid @enderror"
                                        placeholder="Enter Description...">{{$post->description ? $post->description : old('description')}}</textarea>
                                        @error('description')
                                        <small class="text-danger invalid-feedback">{{$message}}</small>
                                        @enderror
                                </div>
